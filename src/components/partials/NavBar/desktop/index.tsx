...
function SimpleLink({
  index,
  element,
}: Readonly<{ index: number; element: NavItemsProps }>) {
  return (
  ...
  return (
    <div className="sticky top-0 z-50 w-full bg-white border-gray-200">
      <nav className="flex flex-row items-center justify-between max-w-[var(--max-content-width)] mx-auto">
        <a href="https://diva-software.io" className="flex items-center gap-3">
          <img
            src="https://ik.imagekit.io/divadev/DIVA/logo.png"
            alt="Website Logo"
            width={40}
            className="grayscale"
          />
          <span className="text-lg font-semibold text-left text-black uppercase dark:text-black whitespace-nowrap">
            Diva Software
          </span>
        </a>
