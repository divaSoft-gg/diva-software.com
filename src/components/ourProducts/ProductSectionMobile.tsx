...
export default function ProductsSectionMobile() {
    ...
    return (
        <section className="px-8 lg:px-0" id="products-section">
            <CenteredLayout>
                <h1 className="mb-10 text-4xl font-semibold text-left lg:text-6xl lg:mb-60 leading-normaltext-white ">{t('ourSolutions.title')}</h1>

                <section className="flex flex-col gap-10 lg:hidden">
                    {
                        solutions.map(
                            (solution: Solutions, index: number) => (
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <div className="flex flex-row items-center gap-4">
                                            <Image
                                                ...
                                                alt="logo"
                                            />
                                            <h6 className="font-semibold tracking-tight lg:text-xl ">{solution.websiteName}</h6>
                                        </div>
                                        <h3 className="text-xl font-semibold tracking-tight text-left lg:text-3xl ">{solution.websiteTitle}</h3>
                                    </div>
                                    <p className="text-xl font-light text-justify ">{solution.websiteDescription}</p>
                                    <Button
                                        variant="shadow"
                                        color="default"
                                        size="md"
